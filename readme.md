...
| `/seller/:sellerId` | GET | Get all products of a seller with ID *sellerId* |  | Status 200 - returns a success message and data of all products of the specified seller <br> Status 404 - returns an error message indicating that the specifid seller does not exist <br> Status 500 - returns an error message |   |
